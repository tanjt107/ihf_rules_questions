        ...
        return new RuleDto
        {
            ...
            [
                ...
                new QuestionDto
                {
                    ...
                    PhraseZhHk = "白隊4號站着接球，跳起先以右腳着地，再以左腳起跳射門。白隊4號走了多少步？",
                    QuestionNumber = "7.3",
                    Answers =
                    [
                        new AnswerDto
                ...
                new QuestionDto
                {
                    ...
                    PhraseZhHk = "一名球員跳起接球後，雙腳同時着地，然後抬起右脚，向旁邊行了一步，跟着左腳移到右腳。他走了多少步？",
                    QuestionNumber = "7.4",
                    Answers =
                    [
                        new AnswerDto
                ...
                new QuestionDto
                {
                    ...
                    PhraseZhHk = "一個球員在空中接球後，先以右腳着地，再以右腳起跳，接着以左、右腳分別先後着地，再把球傳出。該球員共走了多少步？",
                    QuestionNumber = "7.5",
                    Answers =
                    [
                        new AnswerDto
                ...
                new QuestionDto
                {
                    ...
                    PhraseZhHk = "白隊7號運球後想傳球給白隊5號，但白隊5號被對隊包圍着。白隊7號在慌亂中球脫手，但在球觸及地面前又把球接住。如何判決？",
                    QuestionNumber = "7.10",
                    Answers =
                    [
                        new AnswerDto
                ...
                new QuestionDto
                {
                    ...
                    PhraseZhHk = "黑隊3號跳起射門，球被白隊9號封擋落地。接着，白隊9號雙手把球拾起及開始運球反擊，並將球射入黑隊球門。如何判決？",
                    QuestionNumber = "7.14",
                    Answers =
                    [
                        new AnswerDto
                ...
                new QuestionDto
                {
                    ...
                    [
                        new AnswerDto
                        {
                            ...
                            PhraseZhHk = "如果出現消極比賽傾向時，由場內裁判先做出手號17，底線裁判跟着做相同手號",
                            AnswerNumber = "a"
                        },
                        new AnswerDto
                        {
                ...
                new QuestionDto
                {
                    ...
                    PhraseZhHk = "白隊在控球。裁判出示消極進攻警告手號。經過一次傳球，白隊5號射門，黑隊2號封堵，球彈回白隊5號，然後傳給白隊9號。總共完成了多少次傳球？",
                    QuestionNumber = "7.29",
                    Answers =
                    [
                        new AnswerDto
                ...
                new QuestionDto
                {
                    ...
                    PhraseZhHk = "白隊控球，裁判出示消極進攻警告手號。白隊9號嘗試傳球給白隊2號，但被黑隊8號封擋，球回到白隊9號手上。白隊9號嘗試突破，獲得自由球。白隊8號擲自由球球傳給白隊2號。總共多少次傳球？",
                    QuestionNumber = "7.30",
                    Answers =
                    [
                        new AnswerDto
                ...
                new QuestionDto
                {
                    ...
                    PhraseZhHk = "白隊控球，裁判認為白隊有消極進攻的傾向，出示消極進攻警告手號。黑隊見此情況，防守變得更有侵略性，試圖製造自由球機會。3次傳球後，白隊獲得自由球。總共多少次傳球？",
                    QuestionNumber = "7.31",
                    Answers =
                    [
                        new AnswerDto
                ...
                new QuestionDto
                {
                    ...
                    PhraseZhHk = "白隊進攻，裁判認為白隊有消極進攻的傾向，出示消極進攻警告手號。白隊傳球4次後，白隊9號射門，黑隊3號封擋出邊線，白隊獲得界外球。如何判決？",
                    QuestionNumber = "7.32",
                    Answers =
                    [
                        new AnswerDto
                ...
                new QuestionDto
                {
                    ...
                    PhraseZhHk = "白隊控球，裁判出示消極進攻警告手號。白隊5號在4次傳球後射門，球被黑隊3號封擋後回到白隊5號手上。如何判決？",
                    QuestionNumber = "7.33",
                    Answers =
                    [
                        new AnswerDto
                ...
                new QuestionDto
                {
                    ...
                    PhraseZhHk = "黑隊進攻，裁判出示消極進攻警告手號。黑隊7號傳球給黑隊11號，黑隊11號嘗試突破被白隊3號成功防守。黑隊11號擲自由球傳給黑隊2號，黑隊2號射門，被防守球員白隊4號封擋，球回到黑隊11號手上，黑隊11號射門被白隊5號輕輕地推了一下，白隊守門員1號成功守住了球。如何判決？",
                    QuestionNumber = "7.34",
                    Answers =
                    [
                        new AnswerDto
                        {
                            ...
                            PhraseZhHk = "黑隊自由球；新的進攻回合，因為守門員封擋了球",
                            AnswerNumber = "a"
                        },
                        new AnswerDto
                        {
                            ...
                            PhraseZhHk = "黑隊自由球；消極進攻警告手號繼續，黑隊已經傳球2次",
                            AnswerNumber = "b"
                        },
                        new AnswerDto
                        {
                            ...
                            PhraseZhHk = "黑隊自由球；消極進攻警告手號繼續，黑隊已經傳球3次",
                            AnswerNumber = "c",
                            Correct = true
                        },
                        new AnswerDto
                        {
                            ...
                            PhraseZhHk = "黑隊自由球；消極進攻警告手號繼續，黑隊已經傳球4次",
                            AnswerNumber = "d"
                        }
                    ]
                },
                new QuestionDto
                {
                    ...
                    PhraseZhHk = "比分為27:27，比賽時間尚餘20秒，白隊沒有守門員。裁判出示消極進攻警告手號，三次傳球後，白隊8號將球傳給白隊7號，隨後白隊7號射門，被防守球員黑隊2號封擋出邊線，在擲界外球後，桌上的哨音響了，因為白隊要求隊暫停。應該如何恢復比賽？",
                    QuestionNumber = "7.35",
                    Answers =
                    [
                        new AnswerDto
                        ...
                        new AnswerDto
                        {
                            ...
                            PhraseZhHk = "除了接射門外，擲球者還可以傳球給他的隊友",
                            AnswerNumber = "d",
                            Correct = true
                        }
                    ]
                ...
                new QuestionDto
                {
                    ...
                    PhraseZhHk = "白隊進攻，裁判出示消極進攻警告手號，兩次傳球後白隊7號射門，被黑隊8號封擋，白隊8號獲得反彈球後嘗試射門，再次被黑隊8號封擋，白隊8號在接到球後將球傳給有明顯的得分機會的白隊6號。白隊6號被黑隊7號從背後拉倒，完全失去身體平衡。如何判決？",
                    QuestionNumber = "7.36",
                    Answers =
                    [
                        new AnswerDto
