        ...
        return new RuleDto
        {
            ...
            [
                ...
                new QuestionDto
                {
                    ...
                    PhraseZhHk = "防守球員黑隊7號意識到若果白隊中鋒9號接球後將會單獨面對守門員，他再次越過禁區防守，他繞過禁區後防守白隊9號。此時，白隊9號接了球後轉身準備射門，並撞向黑隊7號。如何判決？",
                    QuestionNumber = "6.8",
                    Answers =
                    [
                        new AnswerDto
                ...
                new QuestionDto
                {
                    ...
                    PhraseZhHk = "黑隊守門員1號擋球後，球反彈向正在禁區外準備接球的白隊4號，爲阻擋這明顯得分機會，黑隊2號進入禁區阻礙白隊4號接球。如何判决？",
                    QuestionNumber = "6.9",
                    Answers =
                    [
                        new AnswerDto
                ...
                new QuestionDto
                {
                    ...
                    PhraseZhHk = "白隊守門員1號在禁區內跳起，在空中接獲白隊10號回傳的球後，在禁區外着陸。如何判決？",
                    QuestionNumber = "6.10",
                    Answers =
                    [
                        new AnswerDto
                ...
                new QuestionDto
                {
                    ...
                    PhraseZhHk = "白隊守門員12號從禁區線外的比賽場地跳起，在空中接獲白隊4號的傳球後，將球拍出外底線。然後，他在禁區內着地。如何判決？",
                    QuestionNumber = "6.17",
                    Answers =
                    [
                        new AnswerDto
                ...
                new QuestionDto
                {
                    ...
                    PhraseZhHk = "白隊5號射門，被黑隊守門員12號擋出，球反彈向站在禁區線外的白隊白隊中鋒11號，白隊11號獨自站在禁區線外準備接球。黑隊2號跳起將禁區上空的球打向邊線。由於球上有手膠，球停留在禁區內，守門員並未觸及到球。如何判決？",
                    QuestionNumber = "6.20",
                    Answers =
                    [
                        new AnswerDto
                ...
                new QuestionDto
                {
                    ...
                    PhraseZhHk = "白隊在空門狀態下進攻。黑隊1號守門員封擋白隊11號的射門，並擲守門員球直接射向空門，白隊10號從禁區外起跳試圖封擋，在禁區上空觸球，隨後落地在禁區內，球越過外球門線。如何判決？",
                    QuestionNumber = "6.23",
                    Answers =
                    [
                        new AnswerDto
                ...
                new QuestionDto
                {
                    ...
                    PhraseZhHk = "白隊在空門狀態下進攻。黑隊1號守門員封擋白隊11號的射門，並擲守門員球直接射向空門，白隊10號從禁區外起跳試圖封擋，在禁區上空接住球，隨後着地在禁區內。如何判決？",
                    QuestionNumber = "6.24",
                    Answers =
                    [
                        new AnswerDto
