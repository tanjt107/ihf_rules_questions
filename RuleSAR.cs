        ...
        return new RuleDto
        {
            ...
            [
                ...
                new QuestionDto
                {
                    ...
                    PhraseZhHk = "白隊球隊職員A已經在替補席上被警告過，現在他離開替補區，坐在觀眾席上，繼續抗議裁判的判罰。如何判決？",
                    QuestionNumber = "SAR2",
                    Answers =
                    [
                        new AnswerDto
                        ...
                        new AnswerDto
                        {
                            ...
                            PhraseZhHk = "取消白隊球隊職員A比賽資格（裁判出示紅牌）",
                            AnswerNumber = "c"
                        },
                        new AnswerDto
                        {
                            ...
                            PhraseZhHk = "取消白隊球隊職員A比賽資格，提交書面報告（裁判出示紅牌及藍牌）",
                            AnswerNumber = "d"
                        },
                        new AnswerDto
                        {
