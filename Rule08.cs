        ...
        return new RuleDto
        {
            ...
            [
                new QuestionDto
                {
                    ...
                    [
                        ...
                        new AnswerDto
                        {
                            ...
                            PhraseZhHk = "取消黑隊7號比賽資格及作出書面報告（裁判出示紅牌和藍牌）",
                            AnswerNumber = "c",
                            Correct = true
                        },
                        new AnswerDto
                ...
                new QuestionDto
                {
                    ...
                    [
                        ...
                        new AnswerDto
                        {
                            ...
                            PhraseZhHk = "取消黑隊8號比賽資格及作出書面報告（裁判出示紅牌和藍牌）",
                            AnswerNumber = "d",
                            Correct = true
                        },
                        new AnswerDto
                ...
                new QuestionDto
                {
                    ...
                    [
                        ...
                        new AnswerDto
                        {
                            ...
                            PhraseZhHk = "取消白隊6號比賽資格及作出書面報告（裁判出示紅牌和藍牌）",
                            AnswerNumber = "c",
                            Correct = true
                        },
                        new AnswerDto
                ...
                new QuestionDto
                {
                    ...
                    [
                        ...
                        new AnswerDto
                        {
                            ...
                            PhraseZhHk = "取消黑隊12號比賽資格及作出書面報告（裁判出示紅牌和藍牌）",
                            AnswerNumber = "e"
                        }
                    ]
                },
                ...
                new QuestionDto
                {
                    ...
                    PhraseZhHk =
                        "白隊5號發動反擊時，黑隊球隊職員C從替補席跑向己方的禁區，白隊5號因感困惑而停了下來，裁判認為白隊5號有明顯得分機會，該職員離開白隊5號最少十米，亦沒有觸及白隊5號。如何判決？",
                    QuestionNumber = "8.14",
                    Answers =
                    [
                        new AnswerDto
                        ...
                        new AnswerDto
                        {
                            ...
                            PhraseZhHk = "取消黑隊職員C的比賽資格及作出書面報告（裁判出示紅牌和藍牌）",
                            AnswerNumber = "e",
                            Correct = true
                        },
                        new AnswerDto
                ...
                new QuestionDto
                {
                    ...
                    [
                        ...
                        new AnswerDto
                        {
                            ...
                            PhraseZhHk = "取消黑隊職員D比賽資格及作出書面報告（裁判出示紅牌和藍牌）",
                            AnswerNumber = "e",
                            Correct = true
                        },
                        new AnswerDto
                ...
                new QuestionDto
                {
                    ...
                    PhraseZhHk =
                        "當進入比賽場地時，裁判遇見黑隊4號。當時黑隊4號穿上球衣，但記錄表上沒有他的名字。他對裁判說：「又是你這個白痴!」。及後，比賽至12分鐘，黑隊4號在記錄表上登記成為第十四名球員，被裁判發覺。如何判決？",
                    QuestionNumber = "8.17",
                    Answers =
                    [
                        new AnswerDto
                        ...
                        new AnswerDto
                        {
                            ...
                            PhraseZhHk = "取消黑隊4號比賽資格及作出書面報告（裁判出示紅牌和藍牌）",
                            AnswerNumber = "d",
                            Correct = true
                        },
                        new AnswerDto
                ...
                new QuestionDto
                {
                    ...
                    PhraseZhHk =
                        "裁判判白隊擲自由球後，黑隊球隊職員C進場大叫：“這個自由球應是我們的”。黑隊職員之前並沒有被警告的記錄。如何判決？",
                    QuestionNumber = "8.18",
                    Answers =
                    [
                        new AnswerDto
                ...
                new QuestionDto
                {
                    ...
                    [
                        ...
                        new AnswerDto
                        {
                            ...
                            PhraseZhHk = "取消白隊3號比賽資格，提交書面報告（裁判出示紅牌和藍牌），白隊場內減少一名球員兩分鐘",
                            AnswerNumber = "b",
                            Correct = true
                        },
                        new AnswerDto
