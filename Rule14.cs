        ...
        return new RuleDto
        {
            ...
            [
                new QuestionDto
                {
                    ...
                    PhraseZhHk = "比賽至20:20時，黑隊7號阻截白隊的傳球並即時發動反擊，白隊未能及時回防；一個觀眾跑進場內把黑隊7號拉倒，令其他觀眾引起一陣喧鬧，黑隊職員A進場將拉倒黑隊7號的那個觀衆打倒在地上。如何判決？",
                    QuestionNumber = "14.1",
                    Answers =
                    [
                        new AnswerDto
                ...
                new QuestionDto
                {
                    ...
                    PhraseZhHk = "黑隊界外球，黑隊7號準備好擲球時，發現白隊守門員12號正站在離開球門很遠的地方， 黑隊7號於是直接將球擲向A隊的空門，場內球員白隊3號進入禁區把球截停。如何判決？",
                    QuestionNumber = "14.2",
                    Answers =
                    [
                        new AnswerDto
                ...
                new QuestionDto
                {
                    ...
                    PhraseZhHk = "白隊3號持球在黑隊的九米線繞過黑隊4號，走三步準備射門時，被黑隊4號推了一下；於是，他在第四步後將球射入球門，當時黑隊沒有任何球員能阻礙其射門。如何判決？",
                    QuestionNumber = "14.4",
                    Answers =
                    [
                        new AnswerDto
                ...
                new QuestionDto
                {
                    ...
                    PhraseZhHk = "白隊9號站在對方禁區線外準備接球，翼位白隊10號傳球給他，黑隊3號為了防守此球，故意進入禁區內，將球擋住，這是他在本場比賽中第二次作出這動作。如何判決？",
                ...
                new QuestionDto
                {
                    ...
                    PhraseZhHk = "在一次反擊中，白隊3號運球跑向黑隊球門，當他跳起射門時，觀眾席傳來哨子聲使他分散了注意力。白隊3號沒有射門，只是連同球一起跌落在禁區內。如何判決？",
                ...
                new QuestionDto
                {
                    ...
                    PhraseZhHk = "比賽至26:26時，白隊反擊，白隊5號在黑隊的禁區線前無人防守，正準備射門。這時計時員鳴哨結束比賽，但裁判確定比賽還有20秒才結束。如何處理？",
                ...
                new QuestionDto
                {
                    ...
                    PhraseZhHk = "白隊以7名場內球員進攻。黑隊8號攔截傳球，運球反擊，在他到達能射門的位置前，被白隊3號短暫的抱住，此時白隊守門員12號經過正確替補進入禁區內。如何判決？",
                ...
                new QuestionDto
                {
                    ...
                    PhraseZhHk = "白隊以7名場內球員進攻。黑隊5號攔截傳球後，隨即試圖直接射向空門，卻被白隊6號從背後推倒，導致他失去身體平衡，射門偏出。如何判決？",
                ...
                new QuestionDto
                {
                    ...
                    PhraseZhHk = "白隊以7名場內球員進攻，白隊11號傳球失誤，球越過邊線，黑隊9號擲界外球試圖直接射向空門，球被站得太近的白隊4號阻擋。如何判決？",
                ...
                new QuestionDto
                {
                    ...
                    PhraseZhHk = "白隊以7名場內球員進攻，裁判判白隊7號進攻犯規，黑隊8號拿到球準備擲球直接射向空門，在球離手前，被白隊7號拉倒了，隨後白隊守門員16號經正確替補進入禁區。如何判決？",
